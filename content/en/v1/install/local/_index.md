...
* [K8ssandra installs on Azure Kubernetes Service (AKS)]({{< relref "/v1/install/aks" >}})
* [K8ssandra installs on DigitalOcean Managed Kubernetes Service (DOKS)]({{< relref "/v1/install/doks" >}})
* [K8ssandra installs on Amazon Elastic Kubernetes Service (EKS)]({{< relref "/v1/install/eks" >}})
* [K8ssandra installs on Google Kubernetes Engine (GKE)]({{< relref "/v1/install/gke" >}})
...
{{% alert title="Tip" color="success" %}}
Save the superuser name and password for use in the [Quickstarts]({{< relref "/v1/quickstarts" >}}), if you decide to follow those steps.
{{% /alert %}}

## Next steps

* If you're a developer, and you'd like to get started coding using CQL or Stargate, see the [Quickstart for developers]({{< relref "/v1/quickstarts/developer" >}}).
* If you're a Site Reliability Engineer, and you'd like to explore the K8ssandra administration environment including monitoring and maintenance utilities, see the [Quickstart for Site Reliability Engineers]({{< relref "/v1/quickstarts/site-reliability-engineer" >}}).

For K8ssandra installation details that are specific to cloud providers, see:
    
* K8ssandra installs on [Amazon Elastic Kubernetes Service]({{< relref "/v1/install/eks" >}}) (EKS)
* K8ssandra installs on [DigitalOcean Kubernetes]({{< relref "/v1/install/doks" >}}) (DOKS)
* K8ssandra installs on [Google Kubernetes Engine]({{< relref "/v1/install/gke" >}}) (GKE)
* K8ssandra installs on [Microsoft Azure Kubernetes Service]({{< relref "/v1/install/aks" >}}) (AKS)
