...
With a freshly provisioned cluster on Amazon EKS, consider visiting the [developer]({{< relref "/v1/quickstarts/developer" >}}) and [site reliability engineer]({{< relref "/v1/quickstarts/site-reliability-engineer" >}}) quickstarts for a guided experience exploring your cluster. 
