...
For related information, see [Backup and restore Cassandra with Amazon S3]({{< relref "/v1/tasks/backup-restore/amazon-s3/" >}}).
...
An alternative to MinIO buckets is Amazon S3. See [Backup and restore Cassandra with Amazon S3]({{< relref "/v1/tasks/backup-restore/amazon-s3" >}}).
