...
1. [Ingress]({{< relref "/v1/tasks/connect/ingress" >}}) configured to expose each of the Stargate services (Auth, REST, GraphQL)
...
* For information on using additional deployed components, see the [Tasks]({{< relref "/v1/tasks/" >}}) topics.
