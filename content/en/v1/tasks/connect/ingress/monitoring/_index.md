...
Feel free to explore the other [Traefik ingress]({{< relref "/v1/tasks/connect/ingress/" >}}) topics. 

Also, learn how the steps to use the [monitoring]({{< relref "/v1/tasks/monitor" >}}) features in Grafana, which is preconfigured to visualize the Cassandra and related metrics.
