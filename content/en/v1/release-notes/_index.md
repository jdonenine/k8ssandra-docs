...
* See the new topics that cover:
  *  [Backup and restore with Azure Storage]({{< relref "/v1/tasks/backup-restore/azure/" >}})
  *  [Private registries]({{< relref "/v1/tasks/manage/private-registries/" >}})
...
* [The reference topics]({{< relref "/v1/reference/helm-charts" >}}) for the K8ssandra deployed Helm charts have been updated with the latest descriptions.
...
* [Reference topics]({{< relref "/v1/reference/helm-charts" >}}) for the K8ssandra deployed Helm charts have been updated with the latest descriptions.
...
* [Local]({{< relref "/v1/install/local" >}})
* Amazon Elastic Kubernetes Service ([EKS]({{< relref "/v1/install/eks" >}}))
* DigitalOcean Kubernetes ([DOKS]({{< relref "/v1/install/doks" >}}))
* Google Kubernetes Engine ([GKE]({{< relref "/v1/install/gke" >}}))
* Microsoft Azure Kubernetes Service ([AKS]({{< relref "/v1/install/aks" >}}))
